...
const USE_CASES: UseCase[] = [
  {
    ...
    title: 'MarkLayer for Design Review — Visual Feedback on Live Websites & Mockups',
  ...
  },
  {
    ...
    title: 'MarkLayer for Client Feedback — Visual Review Without Making Clients Install Anything',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Annotations are private until you share the link. There is no public feed. The share link itself is the access mechanism — share carefully. For maximum control, MarkLayer is open source and can be self-hosted.',
      },
    ],
  },
  {
    ...
    title: 'MarkLayer for Remote Teams — Real-Time Visual Collaboration on Any Webpage',
  ...
  },
  {
    slug: 'students',
    audience: 'students',
    title: 'MarkLayer for Students — Free Web Annotation for Studying & Group Projects',
  ...
  },
  {
    ...
    title: 'MarkLayer for Content Creators — Visual Feedback on Articles & Drafts',
  ...
  },
  {
    ...
    title: 'MarkLayer for Marketers — Annotate Landing Pages, Competitor Sites & Campaigns',
