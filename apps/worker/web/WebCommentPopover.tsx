...
import { color, commentCounter, lineWidth, localUser, pushOp } from '@ext/lib/state';
  ...
  return (
    ...
    >
      <div class="flex items-center gap-2.5 px-4 pt-3.5 pb-2">
        ...
        <span class="text-xs text-white/45 font-medium tracking-[0.01em]">New comment</span>
      </div>
